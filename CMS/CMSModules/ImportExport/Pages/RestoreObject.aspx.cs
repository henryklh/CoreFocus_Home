...
public partial class CMSModules_ImportExport_Pages_RestoreObject : CMSModalPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!RequestHelper.IsCallback())
        {
            ...
            {
                if (!exportObj.MainObject.CheckPermissions(PermissionsEnum.Modify, CurrentSiteName, CurrentUser))
                {
    ...
    private bool CheckSpecialSecurityCases(GeneralizedInfo restoredObject)
    {
        ...
        if (userInfo != null)
        {
            ...
            if (userInfo.GetPrivilegeLevel() > CurrentUser.GetPrivilegeLevel())
            {
