...
<%@ Register Src="~/CMSFormControls/Captcha/NewReCaptcha.ascx" TagPrefix="cms" TagName="NewReCaptcha" %>
    ...
    <div class="form-horizontal">
            ...
            <div class="form-group form-group-captcha">
                <div class="editing-form-value-cell editing-form-value-cell-offset">
                    <asp:Panel ID="pnlCaptchaObj" runat="server" DefaultButton="btnOk">
                        ...
                        <cms:NewReCaptcha runat="server" ID="captchaElem" />
                    </asp:Panel>
                </div>
            </div>
        </asp:PlaceHolder>
        <asp:PlaceHolder ID="pnlOkButton" runat="server" Visible="true">
            <div class="form-group form-group-submit">
                <cms:LocalizedButton ID="btnOk" runat="server" ButtonStyle="Primary" CssClass="SubmitButton" OnClick="btnOk_Click" Text="Submit Review"
