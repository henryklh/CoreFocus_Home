...
//using PayPal.Api;
using Kwans.PayPalPayment;

public partial class CMSModules_Ecommerce_Controls_ProductOptions_PayPalCartItemSelector : CMSUserControl
{
    #region "Variables"
    ...
    public void ReloadData()
    {
        ...
        //TreeNode d = DocumentHelper.GetDocument(DocumentID, new CMS.DocumentEngine.TreeProvider());

        //ltlTest.Text = new Guid().ToString();
        //foreach (string s in x.ColumnNames)
        //{
        //    ltlTest.Text += s + " ";
        //}
    ...
    private void AddProductToShoppingCart()
    {
        ...
        TreeNode d = DocumentHelper.GetDocument(DocumentID, new TreeProvider());
        ...
        if (ShoppingCart != null)
        {
            ...
            if (addedItem != null)
            {
                ...
                addedItem.CartItemCustomData.SetValue("DocumentClassName", d.ClassName);
                addedItem.CartItemCustomData.SetValue("DocumentID", d.DocumentID);
