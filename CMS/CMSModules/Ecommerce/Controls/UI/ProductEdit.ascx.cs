    ...
    private void InitProduct()
    {
        ...
        if (isNewSku)
        {
            ...
            else if (CreateNewSiteSKU)
            {
                ...
                // Keio - Set Track Inventory to disabled by default
                Product.SetValue("SKUTrackInventory", "Disabled");
                // Keio - Set Needs Shipping to false by default
                Product.SetValue("SKUNeedsShipping", false);
            }
