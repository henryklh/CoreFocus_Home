...
public partial class CMSModules_Content_Controls_ViewVersion : VersionHistoryControl, IPostBackEventHandler
{
    ...
    {
        DataSet ds = VersionManager.GetDocumentHistory(documentId, "VersionHistoryID !=" + historyId, "ModifiedWhen DESC, VersionNumber DESC", -1, "VersionHistoryID, VersionNumber, ModifiedWhen");
