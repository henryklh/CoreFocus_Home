var Custom = {
    ...
    init: function () {
        ...
        this.cmsTopFixedPanel();
        this.cmsFixedButton();
        this.cmsScrollAnchor();
        this.cmsProductOptionResize();
        this.cmsFormControlTooltip();
        this.cmsCheckAllAbove();
        this.cmsEmbedMapScrollBlock();
        ...
        (function ($) {
            if ($.fn.zettaMenu) {
                ...
                if ($zetta.length > 0) {
                    ...
                    if (Custom.zettaMenuCaret ==  true) {
                        // Formatting 
                        
                        var $tabCaret = '<i class="fa fa-angle-down"></i>';
                            ...
                            if ($(this).siblings().length > 0) {
                                ...
                                $(this).siblings('div').each(function () {
                                    $(this).find('.sub-menu').each(function () {
                                        ...
                                        var $nA = $(this).children('.sub-menu-title');
                                        var $nUL = $(this).children('ul');

                                        if ($nUL.length > 0) {
                                            if (!($nA.children('a').first().children('i.fa').length > 0)) {
                                                $nA.append($subCaret);
                                            }
                                        }
                                    });
    ...
    cmsTopFixedPanel: function () {

        (function ($) {

            if ($('.cms-fixed-panel').length > 0) {

                var $navBar = $('.cms-fixed-panel');
                ...
                var $fixedOffset = Custom.cmsTopFixedPanelOffset;//120;
                ...
                if ($alwaysFixed) {
                    ...
                    if (Custom.currentTop >= $fixedOffset) {
    ...
    cmsFixedButton: function () {

        (function ($) {

            if ($('.FixedButtons').length > 0) {
                if (Custom.currentTop > 500) {
    ...
    cmsScrollAnchor: function () {

        (function ($) {

            // == Back to top button
            if ($('[data-toggle="scrollanchor"]').length > 0) {
                $('[data-toggle="scrollanchor"]').on('click', function (event) {
                    var $anchorTarget;
    ...
    cmsCheckAllAbove: function () {
        (function ($) {
            if ($('.checkbox-list-vertical').length > 0) {
                var cIndex = 0;

                $('.checkbox-list-vertical').each(function () {
                    
                    var i = $('<input id="chkAll_' + cIndex + '" type="checkbox" value="n/a"/>');
                    var l = $('<label for="chkAll_' + cIndex + '">All of above</label>');
                    ...
                    l.on('click', function () {
                        if (i.is(':checked')) {
                            $('.checkbox-list-vertical').find('input[value!="n/a"]').prop("checked", false);
                        }
                        else {
                            $('.checkbox-list-vertical').find('input[value!="n/a"]').prop("checked", true);
                        }
                    });
    ...
    cmsRegisterFormValidation: function () {
        (function ($) {

            if ($('.registration-form').length > 0) {

                $('.registration-form').find('.form-control-error').each(function () {
    ...
    isotopeListRefresh: function () {
        ...
        (function ($) {
            if ($.fn.isotope) {
                ...
                self.isotopeActive = false;
                
                function onHashchange() {
                    var hashFilter = getHashFilter();
                    if (!hashFilter && self.isotopeActive) {
                        return;
                    }
        ...
        (function ($) {
            ...
            if ($.fn.mmenu) {
                ...
                if ($('#MainMenu').length > 0) {
                    $m = $('#MainMenu').clone();
                    $m.attr({ 'id': 'MobileMenu' });
                    $mm = $('<nav id="MobileNav" role="navigation"></nav>')
                    $m.prependTo($mm);
                    $mm.appendTo($('body'));
                }
                ...
                if ($('#MobileNav').length > 0) {
                    ...
                    $('#MobileNav').mmenu({
                        // options go here
                        extensions: ['border-full', 'custom-black'],
                        navbar: {
                            title: 'menu'
                        },
                        navbars: [
                            ...
                            {
                                position: 'bottom',
                                content: '<div class="mm-custom-footer"><a href="/Terms">Terms &amp; Conditions</a><a href="/Privacy-Policy">Privacy Policy</a></div>'
                            }
                        ],
                        offCanvas: {
                            position: 'right',
                    ...
                    //var tButton = $('<a id="RightNavButton" href="#RightNav"><span class="bread-top"></span><span class="bread-middle"></span><span class="bread-bottom"></span></a>');
                    //var tButton = $('#RightNavButton');
                    var tButton = $('.MobileNavButton');
...
(function ($) {
    ...
    $(document).scroll(function (event) {
        Custom.currentTop = $(document).scrollTop();
        Custom.currentWidth = $(window).width();
        Custom.cmsFixedButton();
        Custom.cmsTopFixedPanel();
