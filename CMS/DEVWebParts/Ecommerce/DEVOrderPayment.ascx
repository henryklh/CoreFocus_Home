<%@ Control Language="C#" AutoEventWireup="true" Inherits="DEVWebParts_Ecommerce_HDOrderPayment" CodeFile="~/DEVWebParts/Ecommerce/DEVOrderPayment.ascx.cs" %>
...
<asp:Panel runat="server" ID="pnlPayment">
    ...
    <div class="row">
        <div class="CartContentSummary col-sm-6 col-sm-push-6 col-xs-12">
            <div class="TotalViewer hidden-xs-up">
                <div class="Label">
            ...
            <div class="TotalViewer text-xs-left">
                <div class="Label">
    ...
    <hr />
    <asp:Panel runat="server" ID="pnlOrderSummary" CssClass="OrderSummary" Visible="false">
        ...
        <div class="row">
            <div class="col-sm-6 col-xs-12"><p class="mb-15">You may change your payment method if you have difficulty to use the current payment method.</p></div>
            <div class="FormPanel col-sm-6 col-xs-12">
                <div class="form-horizontal">
                    <div class="form-group">
                        <cms:LocalizedLabel ResourceString="PaymentSummary.Payment" ID="lblPayment" runat="server" Font-Bold="true" EnableViewState="false" CssClass="col-md-4 col-xs-12 Label control-label" />
