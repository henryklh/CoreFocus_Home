<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_DevCustom_Ecommerce_DevPackageSelector" CodeFile="~/CMSWebParts/DevCustom/Ecommerce/DevPackageSelector.ascx.cs" %>
...
<div class="PackageShoppingCartSelector">
    <section class="RequiredProducts panel panel-default">
        <header class="panel-heading">
            <h2 class="panel-title">WORLDCLASS MONITORING AT AN UNBEATABLE VALUE</h2>
    ...
    <asp:RadioButtonList ID="rblTEST" runat="server">
        <asp:ListItem Value="test">test <a href="#">view</a></asp:ListItem>
    </asp:RadioButtonList>
    <section class="RequiredProducts panel panel-default">
        <header class="panel-heading">
