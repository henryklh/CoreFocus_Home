<%@ Control Language="C#" AutoEventWireup="true" Inherits="DEVWebParts_Ecommerce_DEVShoppingCartPreview" CodeFile="~/DEVWebParts/Ecommerce/DEVShoppingCartPreview.ascx.cs" %>
