...
public partial class DEVWebParts_Ecommerce_HDOrderPayment : CMSAbstractWebPart
{
    #region "Variables"
    ...
    public string CartContentTransformationName
    {
        get
        {
            return ValidationHelper.GetString(GetValue("CartContentTransformationName"), "DEV.OnlineStoreTransformations.OrderPayment_CartContent");
        }
        set
        {
    ...
    private void SetupControl()
    {
        ...
        if (ShoppingCart.PaymentOption != null)
        {
            ...
            if (x != null)
            {
                bool IsLivePayment = ValidationHelper.GetBoolean(CMS.DataEngine.SettingsKeyInfoProvider.GetBoolValue(CMS.SiteProvider.SiteContext.CurrentSiteName + ".DEVeWayUseRapidAPI"), false);
