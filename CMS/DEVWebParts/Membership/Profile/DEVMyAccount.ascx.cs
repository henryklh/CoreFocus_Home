                ...
                if (UseBootstrapNavbar)
                {
                    ...
                    try
                    {
                        for (int i = 0; i < tabMenu.TabItems.Count; i++)
                        {
                            ...
                            {
                                ltlNavLinks.Text += "<li class=\"active\"><a class=\"" + x.Text.Replace(" ", "") + "\" target=\"_self\" href=\"" + x.RedirectUrl + "\">" + x.Text + "</a></li>";
                            }
                            else
                            {
                                ltlNavLinks.Text += "<li><a class=\"" + x.Text.Replace(" ", "") + "\" target=\"_self\" href=\"" + x.RedirectUrl + "\">" + x.Text + "</a></li>";
                            }
