...
<asp:Label ID="lab1" runat="server" Visible="true" ForeColor="White"></asp:Label>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xs-4 text-xs-center ">
                <asp:Label ID="labDate" runat="server" CssClass="BookingDate" Visible="false"></asp:Label>
                <asp:DropDownList ID="ddlDate" runat="server" OnSelectedIndexChanged="ddlDate_SelectedIndexChanged" AutoPostBack="true" CssClass="hidden-xs-down lead fix-iphone-honz">
                </asp:DropDownList>
            </div>
        ...
        <div class="row">
             <div class="col-xs-12 text-xs-center ">
                <asp:DropDownList ID="ddlDate2" runat="server" OnSelectedIndexChanged="ddlDate2_SelectedIndexChanged" AutoPostBack="true" CssClass="hidden-md-up m-t-2 lead">
                </asp:DropDownList>
            </div>
        </div>
    </div>
