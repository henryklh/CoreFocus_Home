...
/// </summary>
public partial class CMSWebParts_DEVCustom_DEVTelerikShoppingCartContent : CMSCheckoutWebPart
{
    #region "Variables"
    ...
    public string HeaderText
    {
        get
        {
            return DataHelper.GetNotEmpty(GetValue("HeaderText"), string.Empty);
        }
        set
        {
    ...
    public string FooterText
    {
        get
        {
            return DataHelper.GetNotEmpty(GetValue("FooterText"), string.Empty);
        }
        set
        {
    ...
    public void SetupControl()
    {
        if (!StopProcessing)
        {
            ltlHeader.Text = HeaderText;
            ltlFooter.Text = FooterText;
    ...
    ///// <summary>
    ///// Update Cart Preview - Addition - JavaScript request for backend process
    ///// </summary>
    ///// <param name="sender"></param>
    ///// <param name="e"></param>
    //protected void RadAjaxPanel1_AjaxRequest(object sender, Telerik.Web.UI.AjaxRequestEventArgs e)
    //{
    //    if (e.Argument == "UpdateCartPreview")
    //    {
    //        SetupControl();
    //    }
    //}
