...
<asp:Panel runat="server" ID="pnlAddress">
    ...
    <cms:UIContextPanel ID="pnlUiContext" runat="server" EnableViewState="false">
        <cms:UIForm ID="addressForm" runat="server" ObjectType="Ecommerce.Address" AlternativeFormName="OrdersAddress" RedirectUrlAfterCreate="" UseColonBehindLabel="false" />
    </cms:UIContextPanel>
</asp:Panel>
